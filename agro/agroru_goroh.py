...
def soya_sell():
    url = 'https://agroru.com/doska/goroh/ct-0-p1.htm'
    base_part_url = 'https://agroru.com/doska/goroh/ct-0-p'
    end_part_url = '.htm'
...
def soya_buy():
    url = 'https://agroru.com/spros/goroh/ct-0-p1.htm'
    base_part_url = 'https://agroru.com/spros/goroh/ct-0-p'
    end_part_url = '.htm'
