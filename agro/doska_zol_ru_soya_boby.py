...
def parser_html(html):
    ...
    for ad in ads:
        ...
        if price != '':
            ...
            message = ad.text
            find_product_2 = re.search('(соевые бобы)|(соя бобы)|(бобы сои)', message)
...
def main():
    base_part_url = 'https://doska.zol.ru/Soya/soya.html?sell=on&buy=on&nearby_regions=On&without_exact_fo=On&page='
    for i in range(1, 6):
