...
# def write_csv(data):
#     name_file = 'rynok_apk_Podsolnechnik.csv'
...
def buy():
    url = 'https://rynok-apk.ru/billboard/buy-plants-maslichnye/podsolnechnik/'
...
def sell():
    url = 'https://rynok-apk.ru/billboard/plants-maslichnye/podsolnechnik/'
    # end_part_url = '2.page'
    # urls = url + end_part_url
    get_urls_ads_sell(get_html(url, headers))
    # for i in urls:
    #     get_urls_ads_sell(get_html(i, headers))
