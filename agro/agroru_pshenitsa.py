...
# def write_csv(data):
#     name_file = 'agroru_pshenitsa.csv'
...
def write_in_sql(data):
    ...
    write_sql = '''INSERT INTO Pshenitsa (Ad, Price, Region, Date) VALUES ('%s', '%s', '%s', '%s', '%s')''' % \
...
def soya_sell():
    url = 'https://agroru.com/doska/pshenica/ct-0-p1.htm'
    base_part_url = 'https://agroru.com/doska/pshenica/ct-0-p'
    end_part_url = '.htm'
...
def soya_buy():
    url = 'https://agroru.com/spros/pshenica/ct-0-p1.htm'
    base_part_url = 'https://agroru.com/spros/pshenica/ct-0-p'
    end_part_url = '.htm'
