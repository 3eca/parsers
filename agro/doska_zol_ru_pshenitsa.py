...
def parser_html(html):
    ...
    for ad in ads:
        ...
        if price != '':
            ...
            message = ad.text
            find_product_2 = re.search('(пшеница)', message)
...
def main():
    base_part_url = 'https://doska.zol.ru/Pshenitsa/pshenitsa.html?sell=on&buy=on&nearby_regions=On&nearby_countries' \
                    '=On&without_exact_fo=On&page='
    for i in range(1, 6):
    ...
    # url = 'https://krasnodar.zol.ru/Prodazha/Krupa-gorokhovaya-gorokh-kolotyj-100-tonn_Prodam_gorokh_9813757.html'
